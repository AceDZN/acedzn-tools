      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            {/* Announcement banner kept hardcoded for now or add to dict */}
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link href={DOCS_URL} className="text-sm font-semibold leading-6 text-gray-900">
                {t('HomePage.cta.docs')} <span aria-hidden="true">→</span>
              </Link>
            </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo-600">{t('features.header')}</h2>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              {[
                ...
                <div key={feature.key} className="relative pl-16">
                  ...
                  <dd className="mt-2 text-base leading-7 text-gray-600">{t(`features.items.${feature.key}.description`)}</dd>
                </div>
              ))}
            </dl>
          </div>
