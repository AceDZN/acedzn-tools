...
import { TypewriterEffect } from '@repo/ui/components/ui/typewriter-effect'
...
export async function HeroSection({ direction, lang }: HeroSectionProps) {
                ...
                <div className="mx-auto max-w-6xl relative">
                    <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-16 items-center">
                        ...
                        <div className="text-center lg:text-start relative z-10">
                            ...
                            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl mb-8 sm:min-h-[80px] min-h-[200px]">
